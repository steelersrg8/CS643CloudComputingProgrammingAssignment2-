...
#RUN mkdir /predict
ENV PROG_DIR /cs643cloudcomputingprogrammingassignment2/
COPY test.py /cs643cloudcomputingprogrammingassignment2/
COPY ValidationDataset.csv /cs643cloudcomputingprogrammingassignment2/
COPY trainingmodel.model /cs643cloudcomputingprogrammingassignment2/
